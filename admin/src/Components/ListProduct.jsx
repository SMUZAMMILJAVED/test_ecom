...
const ListProduct = () => {
    ...
    const fetchInfo = async () => {
        await fetch('https://test-ecom-gqfl.vercel.app/allproducts').then((res) => res.json()).then((data) => { setallProducts(data) })
    }
    useEffect(() => {
        fetchInfo()
    }, [])
    ...
    const remove_product=async(id)=>{
        await fetch('https://test-ecom-gqfl.vercel.app/removeproduct',{
            method:'POST',
            headers:{
